    ...
    <div ref={rootRef} className="bg-neutral-950 text-neutral-100">
      ...
      <main className="relative">
        ...
        >
          ...
          <div className="hero-content absolute sm:relative z-10 left-4 right-4 sm:left-0 sm:right-0 top-[73vh] xs:top-[78vh] sm:top-0 flex w-auto sm:w-full max-w-6xl flex-col items-start gap-5 xs:gap-6 sm:gap-8 md:gap-10 text-left sm:pt-[50vh] md:pt-[58vh] sm:pl-2 md:pl-4 lg:pl-0 sm:pr-0">
            <p
              ref={eyebrowRef}
