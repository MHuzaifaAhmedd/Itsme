...
// Import Clothie-specific diagram sections
import {
  ClothieSystemArchitecture,
  ClothieAuthenticationFlow,
  ClothieOrderLifecycle,
  ClothieProductDataFlow,
  ClothieCartManagement,
  ClothieMTOWorkflow,
} from "./sections/clothie";
...
interface ClothieCaseStudyTemplateProps {
  data: CaseStudyData;
}

/**
 * Clothie E-commerce Case Study Template
 * 
 * Custom template for the Naba Hussam (Clothie) project with:
 * - 6 interactive React Flow diagrams
 * - System Architecture with layer breakdown
 * - Authentication flow with guest order linking
 * - Order lifecycle with payment routing
 * - Product data flow with S3 storage
 * - Cart state management with merge logic
 * - Made-to-Order workflow with deposits
 */
export default function ClothieCaseStudyTemplate({ data }: ClothieCaseStudyTemplateProps) {
    ...
    <div ref={rootRef} className="min-h-screen bg-neutral-950 text-white">
      ...
      >
        ...
        <main className="relative">
          ...
          {/* 7. Order Placement Lifecycle (Interactive Diagram) */}
          <ClothieOrderLifecycle />

          {/* 8. Product Data Flow (Interactive Diagram) */}
          <ClothieProductDataFlow />

          {/* 9. Cart State Management (Interactive Diagram) */}
          <ClothieCartManagement />

          {/* 10. Made-to-Order Workflow (Interactive Diagram) */}
          <ClothieMTOWorkflow />
