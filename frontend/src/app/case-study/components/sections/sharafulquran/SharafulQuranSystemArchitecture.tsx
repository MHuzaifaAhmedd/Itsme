...
interface SharafulQuranSystemArchitectureProps {
  description?: string;
  layers?: { name: string; components: string[]; color: string }[];
}

export default function SharafulQuranSystemArchitecture({
  description,
  layers,
}: SharafulQuranSystemArchitectureProps) {
  return (
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-16">
            <SharafulQuranDiagramWithExplanation
              ...
              explanation={sharafulQuranDiagramExplanations["system-architecture"]}
              height="700px"
            />
          </div>
        </ScrollReveal>
