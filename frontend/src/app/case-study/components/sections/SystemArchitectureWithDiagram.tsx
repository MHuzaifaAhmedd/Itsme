...
interface SystemArchitectureWithDiagramProps {
  data: SystemArchitectureData;
}

/**
 * Enhanced System Architecture Section with Interactive Diagram
 * Shows both the original layer view and the interactive React Flow diagram
 */
export default function SystemArchitectureWithDiagram({
  data,
}: SystemArchitectureWithDiagramProps) {
  return (
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-16">
            <DiagramWithExplanation
              ...
              explanation={diagramExplanations['system-architecture']}
              height="700px"
            />
          </div>
        </ScrollReveal>

        {/* Original Layer Breakdown (keep for additional context) */}
