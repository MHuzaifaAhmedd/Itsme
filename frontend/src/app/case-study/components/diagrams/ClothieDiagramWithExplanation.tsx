...
import ClothieDiagramLoader from './ClothieDiagramLoader';

gsap.registerPlugin(ScrollTrigger);

interface ClothieDiagramWithExplanationProps {
  diagramId: string;
  explanation: {
...
export default function ClothieDiagramWithExplanation({
  diagramId,
  explanation,
  height = '700px',
}: ClothieDiagramWithExplanationProps) {
  ...
  return (
    <div ref={containerRef} className="space-y-8">
      {/* Diagram */}
      <div ref={diagramRef}>
        <ClothieDiagramLoader diagramId={diagramId} height={height} showTitle={true} />
      </div>
