...
import { WhatsAppFunnelCustomNode } from './WhatsAppFunnelCustomNode';
...
interface WhatsAppFunnelCaseStudyDiagramProps {
  diagramId: string;
...
const nodeTypes: NodeTypes = {
  custom: WhatsAppFunnelCustomNode,
};

/**
 * Node type colors matching WhatsAppFunnelCustomNode
 */
...
function getLayoutConfig(diagramId: string): {
  ...
  switch (diagramId) {
    ...
    case 'multi-channel-lead-ingestion':
      return {
        direction: 'TB',
        nodeWidth: 170,
        nodeHeight: 70,
    ...
    case 'lead-assignment-algorithms':
      return {
        direction: 'TB',
        nodeWidth: 170,
        nodeHeight: 70,
...
export default function WhatsAppFunnelCaseStudyDiagram({
  diagramId,
  nodes: initialNodes,
  edges: initialEdges,
  title,
  height = '650px',
}: WhatsAppFunnelCaseStudyDiagramProps) {
